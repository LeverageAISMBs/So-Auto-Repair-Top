    ...
    return (
        <section className="min-h-screen h-screen flex items-center justify-center relative pt-16 bg-gradient-to-br from-primary-dark to-primary">
            ...
            <div className="text-center z-10 p-6">
                ...
                <a href="#directory" onClick={handleScrollToDirectory} className="bg-accent-yellow text-primary-dark font-bold text-lg px-8 py-3 rounded-lg shadow-xl hover:bg-accent-yellow-dark hover:-translate-y-0.5 transform transition-all duration-300">
                    Start Your Search
                </a>
            </div>
            <a href="#directory" onClick={handleScrollToDirectory} className="scroll-down absolute bottom-8 left-1/2 -translate-x-1/2" aria-label="Scroll down to directory">
